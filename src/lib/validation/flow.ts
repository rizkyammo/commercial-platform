...
export const shipmentSchema = z.object({
  shipment_date: z.string().optional().nullable().or(z.literal("")),
  transporter_id: z.string().uuid().or(z.literal("")).optional().nullable(),
...
export const bastSchema = z.object({
  bast_date: z.string().optional().nullable().or(z.literal("")),
  receiver_name: z.string().max(200).optional().nullable(),
  signed_by: z.string().max(200).optional().nullable(),
  signed_document_ref: z.string().max(200).optional().nullable(),
  remarks: z.string().max(1000).optional().nullable(),
});
